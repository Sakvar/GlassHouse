...
def run_gossip_scenario() -> tuple[SimulationEngine, ScriptedStubLLM, float, WorldEvent]:
    ...
    agents["max"].ref = AgentRef(agent_id="max", location_id="bedroom_a", activity=Activity.CONVERSING)
    agents["dan"].ref = AgentRef(agent_id="dan", location_id="bedroom_a", activity=Activity.CONVERSING)
